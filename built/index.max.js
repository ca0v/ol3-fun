...
define("ol3-fun/tests/html", ["require", "exports", "ol3-fun/common"], function (require, exports, common_5) {
    "use strict";
    exports.__esModule = true;
    common_5.cssin("html", "\n\n.notebook {\n    background: white;\n    border: 1px solid rgba(66,66,66,1);\n    padding: 4px;\n}\n\n.notebook:after {\n    content: \"+\";\n    position: absolute;\n    left: calc(50% - 5px);\n}\n\n.notebook textarea {\n    width: 240px;\n    height: 80px;\n    background: rgb(250, 250, 210);\n    resize: none;\n}\n");
    function run() {
        alert("check the console for failed assertions");
        var html = "<tr>A<td>B</td></tr>";
        var tr = common_5.html(html);
...
define("ol3-fun/tests/index", ["require", "exports"], function (require, exports) {
    "use strict";
    exports.__esModule = true;
    function run() {
        var l = window.location;
        var path = "" + l.origin + l.pathname + "?run=ol3-fun/tests/";
        var labs = "\n    html\n    ";
        var styles = document.createElement("style");
        document.head.appendChild(styles);
        styles.innerText += "\n    #map {\n        display: none;\n    }\n    .test {\n        margin: 20px;\n    }\n    ";
