...
import { PolylineEncoder as GoogleEncoder } from "../ol3-fun/google-polyline";
...
export function run() {
  ...
  $(".input textarea")
    ...
    .change((args) => {
      ...
      let geom = new LineString(coords);
      geom = <LineString>(
        geom.simplify(
